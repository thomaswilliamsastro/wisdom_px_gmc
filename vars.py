...
elif 'maclap' in hostname:
    wisdom_dir = '/Users/thomaswilliams/Documents/wisdom'
    plot_dir = '/Users/thomaswilliams/Documents/wisdom/plots'
else:
    raise Warning('hostname %s unknown' % hostname)
...
galaxy_info = {'ngc0383': {'pa': 142.2, 'inc': 37.58, 'ml': 2.5,
               ...
               'ngc1574': {'pa': 342, 'inc': 26.75, 'ml': 7.33,
                           'surf': [10 ** 4.983, 10 ** 3.957, 10 ** 4.045,
                                    10 ** 3.797, 10 ** 3.491, 10 ** 3.277,
                                    10 ** 2.718],
                           'sigma_arcsec': [0.035, 0.150, 0.393,
                                            1.279, 2.359, 4.650,
                                            10.289],
                           'qobs': [1, 1, 1,
                                    1, 1, 1,
...
zoom = {'ngc0383': {'centre': None, 'zoom': 200},
        'ngc1574': {'centre': [216, 216], 'zoom': 100},
        'ngc4435': {'centre': None, 'zoom': 80},
        'ngc4697': {'centre': [69, 69], 'zoom': 60},
        }
